...
function PromoMarquee() {
  ...
  return (
    <div className="bg-linear-to-r from-gofarm-green to-emerald-600 text-white overflow-hidden whitespace-nowrap py-1.5 sm:py-2 relative cursor-default">
      ...
      <div className="absolute left-0 top-0 bottom-0 w-6 sm:w-8 md:w-10 lg:w-12 bg-linear-to-r from-gofarm-green to-transparent pointer-events-none" />
      <div className="absolute right-0 top-0 bottom-0 w-6 sm:w-8 md:w-10 lg:w-12 bg-linear-to-l from-emerald-600 to-transparent pointer-events-none" />
    </div>
  );
}
