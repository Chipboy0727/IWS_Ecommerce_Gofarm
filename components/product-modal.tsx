...
export function ProductModal({
  ...
  const handleAddToCart = async () => {
    setIsAdding(true);
    // Adding multiple quantities could be supported by CartContext, assuming addToCart accepts it or we add it loop
    // For now we just call addToCart once
    try {
      await addToCart({
        id: product.id,
        name: product.name,
      ...
      // Optionally we could show a success message inside the modal
    } catch (error) {
          ...
          <div className="p-6 sm:p-8 lg:p-10">
            ...
            <div className="flex flex-col lg:flex-row gap-10">
              ...
              <div className="w-full lg:w-1/2 flex flex-col">
                <h2 className="text-3xl font-extrabold text-gofarm-black mb-2">{product.name}</h2>
                ...
                <div className="flex items-center gap-6 mb-8">
                  ...
                  <button
                    ...
                    disabled={isAdding}
                    className="flex-1 bg-gofarm-green hover:bg-gofarm-light-green text-white font-bold text-lg py-4 px-8 rounded-xl shadow-lg shadow-gofarm-green/30 transition-all active:scale-95 flex items-center justify-center gap-2"
                  >
                    ...
                    <div className="flex items-center gap-4 mb-8">
                      ...
                      <div>
                        <div className="flex text-yellow-400 mb-1">
                          {[...Array(5)].map((_, i) => (
                            <svg key={i} className="w-5 h-5" fill={i < Math.round(product.rating) ? "currentColor" : "none"} stroke="currentColor" viewBox="0 0 20 20">
                        ...
                        <div key={review.id} className="bg-gray-50 p-6 rounded-2xl">
                          <div className="flex items-center justify-between mb-3">
                            ...
                            <div className="flex text-yellow-400">
                              {[...Array(5)].map((_, i) => (
                                <svg key={i} className="w-4 h-4" fill={i < review.rating ? "currentColor" : "none"} stroke="currentColor" viewBox="0 0 20 20">
