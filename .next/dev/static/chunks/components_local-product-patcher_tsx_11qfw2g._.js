...
"[project]/components/local-product-patcher.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
      ...
      <div class="space-y-3 p-5">
        ...
        <div class="flex items-end justify-between gap-4 pt-1">
          <div>
            ...
            ${product.discount && product.discount > 0 ? `<div class="text-sm text-gofarm-gray line-through">${formatPrice(product.price)}</div>` : ""}
          </div>
...
function LocalProductPatcher({ products }) {
    _s();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LocalProductPatcher.useEffect": ()=>{
            const patch = {
                "LocalProductPatcher.useEffect.patch": ()=>{
                    ...
                    if (skeleton && products.length > 0) {
                        ...
                        const heading = Array.from(document.querySelectorAll("h2")).find({
                            "LocalProductPatcher.useEffect.patch.heading": (node)=>node.textContent?.includes("Featured Products")
                        }["LocalProductPatcher.useEffect.patch.heading"]);
            ...
            return ({
                "LocalProductPatcher.useEffect": ()=>window.clearTimeout(timer)
            })["LocalProductPatcher.useEffect"];
        }
    }["LocalProductPatcher.useEffect"], [
        products
...
_s(LocalProductPatcher, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = LocalProductPatcher;
var _c;
__turbopack_context__.k.register(_c, "LocalProductPatcher");
...
//# sourceMappingURL=components_local-product-patcher_tsx_11qfw2g._.js.map