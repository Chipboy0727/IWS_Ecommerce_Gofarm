module.exports = [
"[project]/components/local-product-patcher.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const patch = ()=>{
            ...
            if (skeleton && products.length > 0) {
                ...
                const heading = Array.from(document.querySelectorAll("h2")).find((node)=>node.textContent?.includes("Featured Products"));
...
//# sourceMappingURL=components_local-product-patcher_tsx_03bdo2n._.js.map