        ...
        <div className="py-12 lg:py-16">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="mb-8">
              ...
              <p className="text-gofarm-gray mt-2">{cartItems.length} {cartItems.length === 1 ? "item" : "items"} in your cart</p>
            </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="border-t pt-3 mt-3">
                        <div className="flex justify-between">
                          ...
                          <span className="text-xl font-bold text-gofarm-green">${total.toFixed(2)}</span>
                        </div>
                      </div>
                    </div>
