...
export default function SignInPage() {
  ...
  const handleSocialLogin = (provider: string) => {
    ...
    // Trong thực tế, bạn sẽ redirect đến OAuth URL hoặc gọi API tương ứng
    alert(`${provider} login demo. Please configure OAuth in production.`);
    
    // Ví dụ redirect đến backend OAuth:
    // window.location.href = `${process.env.NEXT_PUBLIC_API_URL}/auth/${provider.toLowerCase()}`;
  };
