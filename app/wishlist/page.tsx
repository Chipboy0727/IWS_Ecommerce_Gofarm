        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl p-6 max-w-sm w-full mx-4 shadow-2xl">
            <div className="text-center">
              ...
              <p className="text-gray-500 text-sm mb-6">Are you sure you want to remove all items from your wishlist? This action cannot be undone.</p>
      ...
      <div className="py-12 lg:py-16">
        <div className="max-w-6xl mx-auto px-4">
          ...
          {wishlist.length === 0 ? (
            ...
            <>
              {/* Select All Bar */}
              <div className="bg-white rounded-t-2xl p-4 border-b border-gray-200 flex items-center justify-between">
                ...
                {selectedItems.size > 0 && (
                  <p className="text-sm text-gofarm-green">{selectedItems.size} selected</p>
                )}
              </div>
                      ...
                      <div className="relative">
                        <div className="absolute top-3 left-3 z-10">
                          <input
                            ...
                            className="w-5 h-5 rounded border-white bg-white/80 text-gofarm-green focus:ring-gofarm-green shadow-sm cursor-pointer"
                          />
                        </div>
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex gap-2 mt-4">
                          <button 
                            ...
                            className="flex-1 py-2 bg-gofarm-green text-white text-sm font-semibold rounded-lg hover:bg-gofarm-light-green transition-colors"
                          >
                            Move to Cart
                          </button>
                          <button 
                            onClick={() => handleRemoveItem(item.id, item.name)} 
                            className="p-2 border border-gray-200 rounded-lg hover:bg-red-50 hover:border-red-200 transition-colors group" 
