      ...
      <div className="py-8 sm:py-12 lg:py-16">
        <div className="max-w-6xl mx-auto px-3 sm:px-4">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-6 sm:mb-8">
            <div>
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gofarm-black">My Wishlist</h1>
            ...
            {wishlist.length > 0 && (
              <div className="flex flex-wrap gap-2 sm:gap-3">
                ...
                <button
                  ...
                  className="px-3 sm:px-4 py-1.5 sm:py-2 bg-white border border-red-200 text-red-500 text-xs sm:text-sm font-semibold rounded-lg hover:bg-red-50 transition-colors flex items-center gap-1.5 sm:gap-2"
                >
                  <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                  </svg>
          ...
          {wishlist.length === 0 ? (
            ...
            <>
              {/* Select All Bar */}
              <div className="bg-white rounded-t-2xl p-3 sm:p-4 border-b border-gray-200 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                ...
                {selectedItems.size > 0 && (
                  <p className="text-xs sm:text-sm text-gofarm-green">{selectedItems.size} selected</p>
                )}
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-5 md:gap-6 mt-4 sm:mt-5">
                {wishlist.map((item) => {
